...
elseif (
    ...
    || empty(trim($data->usertype))
    || empty(trim($data->password))
) :

    $fields = ['fields' => ['name', 'email', 'password', 'usertype']];
    ...
    elseif (strlen($name) < 3) :
        ...
        try {
            ...
            if ($check_email_stmt->rowCount()) :
                ...
                $insert_query = "INSERT INTO `users`(`name`, `email`, `password`, `usertype`) VALUES(:name,:email,:password,:usertype)";
