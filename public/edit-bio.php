...
//    $lga = require_once "./inc/fetch_lga.php";
    ...
    // if($result->num_rows > 0){
        ...
        // $photo = isset($_POST['photo']) ? $_POST['photo']: $user['photo'];
        // if(!($_POST['photo'])){
        ...
        // $_SESSION['user_photo'] = isset($_POST['photo']) ? $_POST['photo']: $user['photo'];
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="regnum" name="regnum" class="form-control" placeholder="Enter your text" value="<?php echo $user[0]['regnum']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="students_name">First name</label>
                                                        <input type="text" name="students_name" id="students_name" class="form-control" placeholder="Enter your text" value=<?php echo ucfirst($user[0]["name"]);?>>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                    <label for="surname">Surname</label>
                                                    <input type="text" id="surname" name="surname" class="form-control" placeholder="Enter your text" value=<?php echo ucfirst($user[0]["surname"]);?>>
                                                </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="students_class">Class</label>
                                                            <input type="text" class="form-control" id="students_class" name="students_class" value=<?php echo strtoupper($user[0]["students_class"]);?>>
                                                ...
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nationality" class="form-control" name="nationality" placeholder="Enter your Nationality" value='<?php echo ucfirst($user[0]["nationality"]);?>'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="state">State</label>
                                                        <input type="text" class="form-control" id="state" name="state" value='<?php echo $user[0]["state"];?>'>
                                                ...
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="lga" name="lga" required="" value='<?php echo ucfirst($user[0]["lga"]);?>'>
                                                ...
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="bloodgroup" id="bloodgroup" class="form-control" placeholder="Enter your Blood Group" value='<?php echo ucfirst($user[0]["bloodgroup"]);?>'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="genotype">Genotype</label>
                                                        <input type="text" id="genotype" name="genotype" class="form-control" placeholder="Enter your genotype" value='<?php echo strtoupper($user[0]["genotype"]);?>'>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xl-4">
                                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6">
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    ...
                                                    <input type="text" id="parents_fullname" name="parents_fullname" class="form-control" placeholder="Enter your text" value='<?php echo ucfirst($user[0]["parents_fullname"]);?>'>
                                                </div>
                                                
        
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    <label for="phone">Phone number</label>
                                                    <input type="number" class="form-control" name="parents_phone" id="parents_phone" placeholder="" value='<?php echo $user[0]["parents_phone"];?>'>
                                                </div>
                                                
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    <label for="email">Email</label>
                                                    <input type="email" class="form-control" id="parents_email" name="parents_email" placeholder="" value='<?php echo ucfirst($user[0]["parents_email"]);?>'>
                                                </div>
                                            <!-- </form> -->
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <div class="form-group col-lg-6 col-xl-12">
                                                ...
                                                <input type="text" id="occupation" class="form-control" name="occupation" placeholder="Enter your text" value='<?php echo ucfirst($user[0]["occupation"]);?>'>
                                            </div>
                                            
                                            <div class="form-group col-lg-6 col-xl-12">
                                                <label for="wphone">WhatsApp number</label>
                                                <input type="number" class="form-control" id="wphone" name="wphone" placeholder="" value='<?php echo ucfirst($user[0]["wphone"]);?>'>
                                            </div>
                                            
                                            <div class="form-group col-lg-6 col-xl-12">
                                                <label for="address">Residential Address</label>
                                                <textarea name="address" id="address" cols="31" rows="3"><?php echo ucfirst($user[0]["address"]);?></textarea>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <!-- <form> -->
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    ...
                                                    <input type="text" id="sponsor_fullname" name="sponsor_fullname" class="form-control" placeholder="Enter your text" value='<?php echo ucfirst($user[0]["sponsor_fullname"]);?>'>
                                                </div>
                                                
        
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    <label for="sponsor_phone">Phone number</label>
                                                    <input type="number" class="form-control" name="sponsor_phone" id="sponsor_phone" placeholder="" value='<?php echo ucfirst($user[0]["sponsor_phone"]);?>'>
                                                </div>
                                                
                                                <div class="form-group col-lg-6 col-xl-12">
                                                    <label for="sponsor_email">Email Address</label>
                                                    <input type="email" class="form-control" id="sponsor_email" name="sponsor_email" placeholder="" value='<?php echo ucfirst($user[0]["sponsor_email"]);?>'>
                                                </div>
                                            <!-- </form> -->
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <div class="form-group col-lg-6 col-xl-12">
                                                ...
                                                <input type="text" id="sponsor_occupation" class="form-control" name="sponsor_occupation" placeholder="Enter your text" value='<?php echo ucfirst($user[0]["sponsor_occupation"]);?>'>
                                            </div>
                                            
                                            <div class="form-group col-lg-6 col-xl-12">
                                                <label for="sponsor_wphone">WhatsApp number</label>
                                                <input type="number" class="form-control" id="sponsor_wphone" name="sponsor_wphone" placeholder="" value='<?php echo ucfirst($user[0]["sponsor_wphone"]);?>'>
                                            </div>
                                            
                                            <div class="form-group col-lg-6 col-xl-12">
                                                <label for="sponsor_address">Residential Address</label>
                                                <textarea name="sponsor_address" id="sponsor_address" cols="31" rows="3"><?php echo ucfirst($user[0]["sponsor_address"]);?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <input class="btn waves-effect waves-light btn-block btn-outline-success" id="sa-successs" type="submit" value="Update">
