                ...
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <?php
                        if( $user[0]['photo'] == null){
                            ...
                            echo "<img src=\"./inc/images/".$user[0]['photo']."\" alt=".$user[0]['name']." class=\"img-thumbnail rounded-circle header-profile-user\" \">";
                        }
                    ?>
                    <!-- <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-3.jpg"
                        alt="Header Avatar"> -->
                    <span class="d-none d-sm-inline-block ml-1"><?php echo ucwords($username); ?></span>
                    <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a id="sa-delete" class="dropdown-item d-flex align-items-center justify-content-between"
                        href="javascript:void(0)">
                        <span>Lock Account</span>
                    </a> -->
                    <a id="sa-warning" class="dropdown-item d-flex align-items-center justify-content-between"
                        href="javascript:void(0)">
                        <span>Log Out</span>
                    </a>
                </div>
