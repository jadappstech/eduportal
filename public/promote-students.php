                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form action="./inc/promote-students-api.php" method='POST'>
                                <div class="row">
                                    <div class="col-md-3 col-xl-3">
                                        ...
                                        for($i = 0; $i < count($form_class_query); $i++){
                                            ...
                                            // echo $studentsname};?>
                                            <input type='checkbox' id='' name='<?php echo $form_class_query[$i]['id']; ?>' class='' checked>
                                        ...
                                        ?>
                                        <br>
                                    <button type="Submit" class="form-control btn-primary">Promote students</button>
                                    </div>
                                </div> 
                            </form>
                        </div>
